...
double af_samp[2*s_cnt];	// sample values of af()
double df_samp[2*s_cnt];	// sample values of df()
double* af;			// pointer to center of sample array of af()
double* df;			// pointer to center of sample array of df()
